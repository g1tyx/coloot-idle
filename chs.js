...
var cnItems = {
    ...
    "Godly": "虔诚",
    "Auto": "自动",
    "into the text box below and click \"WIPE\".": "进入下面的文本框，然后点击\“删除\”。",
    "Number Format:": "数字格式：",
    "Reset all Artifacts and get the Gems back. This will reset your\n                Equipment and Level. You will keep your Crystal Levels.": "重置所有的神器并取回宝石。这将重置你的\n装备和等级。你将保持你的水晶等级。",
    "This will reset absolutely everything! Are you sure? Type": "这将重置一切！你确定吗？输入",
    "": "",
    "": "",
    "": "",
    "": "",
